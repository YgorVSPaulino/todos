<template>
    <div class="flex flex-col items-center p-10">
      ...
      <button class="bg-red-500 text-white p-2 rounded" @click="limparTarefas" v-if="todos.length">Limpar</button>
      <div class="block mt-5">
        <input type="text" placeholder="Digite sua Tarefa..." class="p-2 border rounded" v-model="newTodos.text">
        <button class="ml-3 bg-blue-500 text-white p-2 rounded" @click="addNovaTarefa()">Adicionar</button>
      </div>
    </div>
  </template>
